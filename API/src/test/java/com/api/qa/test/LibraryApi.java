...
public class LibraryApi {
	...
	public void addBook(String isbn, String aisle)
	{
		...
		RestAssured.given().header("Content-Type","application/json").body(Body.addBookLibraryPayload(isbn,aisle))
		.when().post("Library/Addbook.php")
		.then().log().all().assertThat().body("msg", equalTo("successfully added")).extract().response().asString();
