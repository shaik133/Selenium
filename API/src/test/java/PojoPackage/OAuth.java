...
String url= "https://rahulshettyacademy.com/getCourse.php?code=4%2F0AX4XfWhcngkXoiEO1OePSLMUAD9tzdlVPMaWIppA-zt0oKzz_90kWJnnh5zgDeXjc7VHjg&scope=email+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fuserinfo.email+openid&authuser=0&prompt=none";
...
//Get Access token
		String response=RestAssured.given().urlEncodingEnabled(false).queryParam("code", code)
		.queryParam("client_id", "692183103107-p0m7ent2hk7suguv4vq22hjcfhcr43pj.apps.googleusercontent.com")
...
//Final Response		
String finalresponse=RestAssured.given().queryParam("access_code", access_token)
